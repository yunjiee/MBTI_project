...
def dataset_exporter(train, dev, directory):
    train_file = os.path.join(directory, '1train.csv')
    dev_file = os.path.join(directory, '1dev.csv')
...
path = "/content/drive/My Drive/full/data/subprocessed_all_posts_data.csv"
directory = "/content/drive/My Drive/full/data"  # 保存文件的目录
