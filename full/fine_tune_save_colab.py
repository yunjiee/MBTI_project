...
from bert_model_colab import get_bert_model, get_optimizer
...
def main():
    ...
    parser.add_argument("--do_train", action='store_true', default=True)#是否經過訓練 =>都默認有，並執行程式
    ...
    parser.add_argument("--learning_rate", default=1e-5, type=float)#學習率

    ############################parser.add_argument("--num_train_epochs", default=3, type=int) 太少了
    parser.add_argument("--num_train_epochs", default=9, type=int)
    ...
    # 在这里定义 WEIGHTS_NAME 和 CONFIG_NAME
